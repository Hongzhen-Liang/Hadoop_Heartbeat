...
public class DatanodeDescriptor extends DatanodeInfo {
   ...
   */
  public DatanodeDescriptor(DatanodeID nodeID,
                            String networkLocation, long heartbeatExpireInterval) {
    super(nodeID, networkLocation);
    setHeartbeatExpireInterval(heartbeatExpireInterval);
    System.out.println("this DatanodeDescriptor="+this.heartbeatExpireInterval);
    setLastUpdate(Time.now());
    setLastUpdateMonotonic(Time.monotonicNow());
  }
  private long heartbeatExpireInterval;
  public void setHeartbeatExpireInterval(long heartbeatExpireInterval){
  ...
  void updateHeartbeatState(StorageReport[] reports, long cacheCapacity,
    ...
    updateStorageStats(reports, cacheCapacity, cacheUsed, xceiverCount,
        volFailures, volumeFailureSummary);
    System.out.print("Data Node "+this+","+this.getDatanodeUuid()+",heartbeatExpireInterval="+this.heartbeatExpireInterval+" ");
    Date now = new Date();
